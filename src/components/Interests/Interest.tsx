...
const gifs = [
  ...
  { src: "/images/games/metal_gear_solid_3.gif", alt: "Metal Gear Solid", quote: "I'm no hero. Never was, never will be." },
  ...
  { src: "/images/games/fallout.webp", alt: "Fallout", quote: "I survived because the fire inside burned brighter than the fire around me." },
  ...
  { src: "/images/animes/zangetsu.png", alt: "Zangetsu", quote: "Do you know why i hate the rain?" },
  ...
  { src: "/images/animes/cowboy_bebop.gif", alt: "CowboyBebop", quote: "See you space cowboy!" },
